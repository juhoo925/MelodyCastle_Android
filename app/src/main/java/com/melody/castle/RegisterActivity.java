...
public class RegisterActivity extends AppCompatActivity implements ResultCallBack {
...
//            String lang = mLanguageView.getText().toString();
//            ServerManager.register(email, username, password, phone, paypal, country, lang,this);
        }
    }
    ...
    public void doAction(String result) {
        ...
        try {
            ...
            if (ret.equals(Global.KEY_SUCCESS)) {
                ...
                Intent i = new Intent(RegisterActivity.this, VerifyCodeActivity.class);
                startActivity(i);
                finish();
            }
            else {
                int code = json.getInt(Global.KEY_CODE);
                if ( code == -2 ) {//Invalid user!
